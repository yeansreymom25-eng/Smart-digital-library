    ...
    >
      <nav className="pointer-events-auto relative hidden rounded-[22px] bg-[#efede9]/90 p-1.5 shadow-[0_16px_34px_rgba(15,23,42,0.08)] backdrop-blur md:block">
        <div className="relative grid grid-cols-3 gap-1">
          <span
            aria-hidden="true"
            className="absolute bottom-0 left-0 top-0 w-[calc(33.333%-0.1875rem)] rounded-[16px] bg-[#dfddda] shadow-[inset_0_1px_0_rgba(255,255,255,0.8)] transition-transform duration-500 ease-[cubic-bezier(0.22,1,0.36,1)]"
