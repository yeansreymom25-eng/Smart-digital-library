          ...
          <div className="flex flex-col gap-6">
            <div className="flex items-start justify-between">
              ...
              <button
                ...
                onClick={() => void logout()}
                disabled={isLoading}
                className="mt-2 rounded-full border border-[#fecaca] bg-[#fff5f5] px-5 py-2.5 text-sm font-semibold text-[#c93d3d] transition hover:bg-[#ffefef] disabled:opacity-50"
              >
