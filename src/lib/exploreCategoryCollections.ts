...
export const khmerExploreCategories: ExploreCategoryCollection[] = [
  {
    id: "self-help",
    title: "Self-Help",
    subtitle: "Popular Khmer self-growth and practical books for everyday improvement.",
    color: "from-[#6e8465] to-[#49604a]",
    heroBookId: "khmer-1",
  ...
  },
  {
    id: "fantasy",
    title: "Fantasy",
    subtitle: "Magical worlds and adventure in Khmer storytelling.",
    color: "from-[#d85f58] to-[#9f3e3a]",
    heroBookId: "khmer-2",
  ...
  },
  {
    id: "historical",
    title: "Historical",
    subtitle: "Khmer historical titles and culturally rooted reading.",
    color: "from-[#5faa39] to-[#467d28]",
    heroBookId: "khmer-3",
  ...
  },
  {
    id: "sci-fi",
    title: "Sci-Fi",
    subtitle: "Futuristic and imaginative Khmer speculative reads.",
    color: "from-[#1d2bca] to-[#10196f]",
    heroBookId: "khmer-4",
  ...
  },
  {
    id: "science",
    title: "Science",
    subtitle: "Books for curious Khmer minds who enjoy ideas and discovery.",
    color: "from-[#db5bc8] to-[#983992]",
    heroBookId: "khmer-6",
  ...
  },
  {
    id: "finance",
    title: "Finance",
    subtitle: "Smart money and practical thinking in Khmer.",
    color: "from-[#d5ad56] to-[#9a7331]",
    heroBookId: "khmer-1",
    heroImage: khmerBookImages[0],
    backgroundImages: khmerBackgroundBooks,
  ...
  },
  {
    id: "mystery",
    title: "Mystery",
    subtitle: "Suspenseful Khmer books that keep readers curious until the end.",
    color: "from-[#6954f0] to-[#4532aa]",
    heroBookId: "khmer-2",
    heroImage: khmerBookImages[1],
    backgroundImages: khmerBackgroundBooks,
  ...
  },
  {
    id: "philosophy",
    title: "Philosophy",
    subtitle: "Reflective and idea-driven Khmer reads for slow thoughtful reading.",
    color: "from-[#cb3b2e] to-[#8d1f18]",
    heroBookId: "khmer-3",
    heroImage: khmerBookImages[2],
    backgroundImages: khmerBackgroundBooks,
  ...
  },
  {
    id: "biography",
    title: "Biography",
    subtitle: "Personal stories and life journeys in Khmer.",
    color: "from-[#b2be4d] to-[#76812e]",
    heroBookId: "khmer-4",
    heroImage: khmerBookImages[3],
    backgroundImages: khmerBackgroundBooks,
  ...
  },
  {
    id: "romance",
    title: "Romance",
    subtitle: "Warm and emotional Khmer books for comfort reading.",
    color: "from-[#d9d9db] to-[#aeb3b9]",
    heroBookId: "khmer-5",
    heroImage: khmerBookImages[4],
    backgroundImages: khmerBackgroundBooks,
  ...
  },
  {
    id: "travel",
    title: "Travel",
    subtitle: "Place-based Khmer books for wanderers.",
    color: "from-[#402420] to-[#241311]",
    heroBookId: "khmer-6",
    heroImage: khmerBookImages[5],
    backgroundImages: khmerBackgroundBooks,
  ...
  },
  {
    id: "drama",
    title: "Drama",
    subtitle: "Emotion-rich Khmer stories with tension and strong characters.",
    color: "from-[#5dcf69] to-[#359048]",
    heroBookId: "khmer-1",
    heroImage: khmerBookImages[0],
    backgroundImages: khmerBackgroundBooks,
  ...
  },
  {
    id: "cooking",
    title: "Cooking",
    subtitle: "Practical Khmer cooking books for everyday readers.",
    color: "from-[#6cf0ca] to-[#3cb98e]",
    heroBookId: "khmer-2",
    heroImage: khmerBookImages[1],
    backgroundImages: khmerBackgroundBooks,
  ...
  },
  {
    id: "horror",
    title: "Horror",
    subtitle: "Dark and atmospheric Khmer reads with a stronger edge.",
    color: "from-[#334e73] to-[#223754]",
    heroBookId: "khmer-3",
    heroImage: khmerBookImages[2],
    backgroundImages: khmerBackgroundBooks,
